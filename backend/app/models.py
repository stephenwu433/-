"""SQLAlchemy ORM models for PlanFlow business tables."""
...
class Project(Base):
    ...
    member_daily_hours: Mapped[float] = mapped_column(
...
class PhaseWorkItem(Base):
    __tablename__ = "phase_work_items"
...
class TaskTimeEntry(Base):
    ...
    __table_args__ = (
        UniqueConstraint("task_id", "user_id", "work_date", name="uq_task_time_entries_task_user_date"),
    )
...
class Notification(Base):
    ...
    category: Mapped[str] = mapped_column(String, nullable=False, default="一般")
    title: Mapped[str] = mapped_column(String, nullable=False)
    body: Mapped[str | None] = mapped_column(Text, nullable=True)
    link_path: Mapped[str | None] = mapped_column(String, nullable=True)
